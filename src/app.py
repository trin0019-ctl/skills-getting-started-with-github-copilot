...
activities = {
    ...
    "Soccer Team": {
        "description": "Build teamwork and compete in friendly soccer matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve stroke technique and endurance in the pool",
        "schedule": "Wednesdays and Fridays, 3:00 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["maya@mergington.edu"]
    },
    "Art Studio": {
        "description": "Practice painting, drawing, and mixed media art",
    ...
    "Debate Club": {
        "description": "Practice public speaking and persuasive argument skills",
